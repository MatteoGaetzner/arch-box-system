...
g.python_host_prog = os.getenv("HOME").."/.local/share/miniconda3/envs/neovim-python2/bin/python2" -- python2 executable
g.python3_host_prog =  os.getenv("HOME").."/.local/share/miniconda3/envs/neovim-python3/bin/python3" -- python3 executable
...
opt.ignorecase = true -- make search ignore case of letters
